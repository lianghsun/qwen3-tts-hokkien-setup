...
# 循環使用的聲色描述（用台語/閩南語寫，引導模型用閩南語腔調生成）
VOICE_DESIGNS = [
    "伊是一个台灣的中年查某人，用伊家己的母語台語咧講話，語氣親切溫柔，像佇和厝邊頭尾鬥陣咧話仙，自然閣有人情味。",
    "伊是一个台灣的中年查埔人，用道地的台語在講話，語氣穩重，像老一輩的人咧說古，聲音渾厚有力，帶著歲月的重量。",
    "伊是一个台灣的年輕查某，用活潑的台語咧講話，語調輕快，親像佇和好朋友鬥陣咧聊，笑聲攏帶出來矣，自然閣有朝氣。",
    "伊是一个台灣的年輕查埔，用自然的台語咧講話，語氣輕鬆隨意，親像佇日常生活中分享家己的代誌，清朗閣俐落。",
    "伊是一个台灣的阿嬤，用道地的台語咧講話，語速較慢，語氣慈祥溫和，像咧疼惜囝仔，充滿歲月的溫柔。",
    "伊是一个台灣的阿公，用濃厚的台語咧講話，語速緩慢，聲音沙啞厚實，像老說書人咧娓娓道來，有古早的韻味。",
    "伊是一个台灣的年輕查某，台語講了甜美閣明亮，音調較高，語氣親切，充滿年輕人的活力閣熱情。",
    "伊是一个台灣的成熟查埔，台語講得條理清楚，語速適中，語氣自信從容，有一种穩重大方的氣質。",
]
